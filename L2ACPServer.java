...
import com.stalkersts.l2acp.crypto.AesCrypto;
import com.stalkersts.l2acp.requests.L2ACPRequest;
import com.stalkersts.l2acp.tasks.DatamineTask;
...
public class L2ACPServer {
	...
	final String ApiKey = "stalkersts";
	...
	public L2ACPServer()
	{
		HttpServer server;
		try {
	        server = HttpServer.create(new InetSocketAddress(8000), 0); //8000
